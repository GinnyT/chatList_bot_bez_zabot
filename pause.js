...
bot.on([message("text"),"callback_query"], (ctx) => {
    ctx.reply("🚧...бот сейчас в разработке... 🛠️🔧⚙️\n\n хочу вот что доделать:\n1.	Верстка кнопок: ширина, прижатость иконки галка\n3.	Хранение from\n4.	Отвечать в группе только если тебя спрашивают\n5.	Функция 'поделиться' > вывод списка на печать\n6.	Несколько списков для каждого чата (но это не точно)\n7.	Режим одного сообщения-списка, нажатие => обновление, как BotFatherMenu\n8.  Дабл клик на элемент списка: первый - зачеркнуто, второй - удалено... \n🚧...\n\nПо всем вопросам можете обратиться ко мне лчино: @ToxMilkoff");
});
